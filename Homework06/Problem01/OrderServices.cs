...
namespace Problem01
{
    ...
    public class OrderServices
    {
        ...
        {
            XmlSerializer xmlSerializer = new XmlSerializer(typeof(OrderServices));
            using (FileStream theXmlFileToCreate = new FileStream("Order.xml", FileMode.Create))
            {
                xmlSerializer.Serialize(theXmlFileToCreate, order);
            }
        }
        ...
        public List<Order> Import()
        {
            ...
            {
                List<Order> deserializedObjects= (List<Order>)xmlSerializer.Deserialize(theXmlFile);
        ...
        public string searchOrderByMoney(int minNum, int maxNum, List<Order> orders)
        {
            try
            {
        ...
        public string searchOrderByName(string customerName, List<Order> orders)
        {
